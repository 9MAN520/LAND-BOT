...
module.exports.run = async function({ api, event }) {
        ...
        if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
                ...
                const fs = require("fs");
                return api.sendMessage("🩵🍒 𝙷𝚎𝚕𝚕𝚘 𝙴𝚟𝚎𝚛𝚢𝚘𝚗𝚎 🙋🏻‍♀️", event.threadID, () => api.sendMessage({body:`💝 𝐃𝐉 𝐏𝐀𝐏𝐀 𝐊𝐀 𝐁𝐎𝐓 💝\n✧═════════•❁❀❁•═════════✧\n💝 वेलकम करो जल्दी जल्दी मेरा आपका प्यारा बोट आ गया 💝\n✧═════════•❁❀❁•═════════✧\n🇲‌🇦‌🇸‌🇹‌🇮‌ 🇧‌🇴‌🇹‌\n✧═════════•❁❀❁•═════════✧\n🍒🌸🍒 आपका ग्रुप को मेरे बॉस डज पापा ज़ी ने अप्रूव कर दिया है 🍒🌸🍒\n✧═════════•❁❀❁•═════════✧\n ☟☟ 🍒🩵 बोट का मालिक  ☟☟\𝐧🇩‌🇯‌ 🇵‌🇦‌🇵‌🇦‌ 🇻‌🇮‌🇱‌🇦‌🇳‌ \n✧═════════•❁❀❁•═════════✧\n🩷🩵 आप लोगो को किसी भी तारे की हेल्प चाहिए तो मेरे बॉस से कांटेक्ट कर सकते हो 🌸💝🍒\n✧═════════•❁❀❁•═════════✧\nUse ${global.config.PREFIX}help to see commands.\nexample :\n${global.config.PREFIX}video7 (video songs)\n${global.config.PREFIX}music (audio songs)\n${global.config.PREFIX}help2 (command list)\n${global.config.PREFIX}info\n✧═════════•❁❀❁•═════════✧\n💝🍒 ये लो मेरे बॉस की फेसबुक की लिंक ☟☟☟\https://www.facebook.com/share/1JHXTn7LtY/=61573328623221\n✧═════════•❁❀❁•═════════✧\n🩵🌸🍒 फ़ोन नम्बर मेरे बॉस का ☟☟☟\n[ 𝟴𝟬𝟳𝟱𝟰𝟵𝟴𝟳𝟱𝟬 ]`, attachment: fs.createReadStream(__dirname + "/cache/djvilan.mp4")} ,threadID));
        }
        else {
                try {
